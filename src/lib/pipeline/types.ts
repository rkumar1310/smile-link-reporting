...
// Includes all main questions and sub-questions (Q2a, Q6a-d, Q16a-b)
...
// The 8 scenario section keys - matches ScenarioResponseSchema in ContentGenerationAgent
export const SCENARIO_SECTION_KEYS = [
  'personal_summary', 'context', 'options', 'comparison',
  'tradeoffs', 'process', 'costs', 'risk'
] as const;

export type ScenarioSectionKey = typeof SCENARIO_SECTION_KEYS[number];

// Structured scenario sections - typed data from LLM structured output
